...
const Member = () => {
    ...
    //const regions = ["Africa", "Asia", "Europe", "North America", "Not Defined", "Oceania", "South America"]
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await fetch('https://stag-protocol-labs-network-api.herokuapp.com/v1/members')
            const jsonData = await response.json()
            const updatedData = jsonData.map((user: User) => ({
                ...user,
    ...
    return (
        <><Header></Header><div className=" panel ">
                        ...
                        {filterData.map((item) => (
                            <div key={item.uid} className="member__list card">
                                ...
                                <div className="member__details">
                                    ...
                                    <div className="member__department">Lab</div>
